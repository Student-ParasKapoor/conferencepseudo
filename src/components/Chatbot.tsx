...
const Chatbot: React.FC = () => {
  ...
  const qaDatabase: { [key: string]: string } = {
    // Conference Basics
    'when is the conference': 'The INTERNATIONAL CONFERENCE ON RECENT ADVANCES IN ENGINEERING (ICRAE 2025) is scheduled for February 20-21, 2026.',
    'conference dates': 'The INTERNATIONAL CONFERENCE ON RECENT ADVANCES IN ENGINEERING (ICRAE 2025) is scheduled for February 20-21, 2026.',
    'when does the conference happen': 'The INTERNATIONAL CONFERENCE ON RECENT ADVANCES IN ENGINEERING (ICRAE 2025) is scheduled for February 20-21, 2026.',
    'dates of conference': 'The INTERNATIONAL CONFERENCE ON RECENT ADVANCES IN ENGINEERING (ICRAE 2025) is scheduled for February 20-21, 2026.',
    'conference schedule': 'The INTERNATIONAL CONFERENCE ON RECENT ADVANCES IN ENGINEERING (ICRAE 2025) is scheduled for February 20-21, 2026.',
    'when is icrae 2025': 'The INTERNATIONAL CONFERENCE ON RECENT ADVANCES IN ENGINEERING (ICRAE 2025) is scheduled for February 20-21, 2026.',
    'icrae 2025 dates': 'The INTERNATIONAL CONFERENCE ON RECENT ADVANCES IN ENGINEERING (ICRAE 2025) is scheduled for February 20-21, 2026.',
    'conference timing': 'The INTERNATIONAL CONFERENCE ON RECENT ADVANCES IN ENGINEERING (ICRAE 2025) is scheduled for February 20-21, 2026.',
    'when is the event': 'The INTERNATIONAL CONFERENCE ON RECENT ADVANCES IN ENGINEERING (ICRAE 2025) is scheduled for February 20-21, 2026.',
    'event dates': 'The INTERNATIONAL CONFERENCE ON RECENT ADVANCES IN ENGINEERING (ICRAE 2025) is scheduled for February 20-21, 2026.',
    'what is the submission deadline': 'The submission deadline for papers is December 31, 2025.',
    'deadline for submission': 'The submission deadline for papers is December 31, 2025.',
    'when do i submit papers': 'The submission deadline for papers is December 31, 2025.',
    ...
    'what are the key dates': 'Key dates are: Submission Deadline - December 31, 2025, and Conference Dates - February 20-21, 2026.',
    'important dates': 'Key dates are: Submission Deadline - December 31, 2025, and Conference Dates - February 20-21, 2026.',
    'key conference dates': 'Key dates are: Submission Deadline - December 31, 2025, and Conference Dates - February 20-21, 2026.',
